...
- 次に検討する仕様: `10_CONTENT.md`

`0.1.0`は初期仮説です。実際のスライドを一度生成し、出力と検査まで完了できることを確認してから`1.0.0`とします。
...
3. `00_MASTER.md`、`50_OUTPUTS.md`および完成済みの個別仕様書をプロジェクト知識に追加します。
