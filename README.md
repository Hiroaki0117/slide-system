...
| 配布物 | 位置づけ | 状態 |
|---|---|---|
| `dist/slide-system-free-v0.2.0.zip` | 無料版Claude向け。6〜8枚、HTML先行納品、次ターンでPDF化 | 実機検証待ち |
...
2. 無料版では、スキル追加画面から`slide-system-free-v0.2.0.zip`をアップロードします。
