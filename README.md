...
| 配布物 | 位置づけ | 状態 |
|---|---|---|
| `dist/slide-system-free-v0.2.1.zip` | 無料版Claude向け。6〜8枚を基本にHTML先行納品。内容・安全条件が収まらない場合は最大10枚 | 再検証待ち |
...
2. 無料版では、スキル追加画面から`slide-system-free-v0.2.1.zip`をアップロードします。
...
- バージョン: `0.9.0`
- 状態: 無料版`v0.2.0`の実機結果を反映し、内容・安全・ペース・出典検査を強化した`v0.2.1`を作成
- 既定の出力プロファイル: `html_pdf`
- 既定のコンテンツモード: `standalone`
- 既定のデザインテーマ: `warm_clean`
- 既定のレイアウト方式: `hybrid`
- 次の工程: 無料版`v0.2.1`を同じ代表ケースで再検証
