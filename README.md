...
無料版Claudeでの再検証用に、仕様・テンプレート・生成スクリプトをまとめたカスタムスキルを`skills/slide-system/`に用意しています。配布用ファイルは`dist/slide-system-skill-v0.1.1.zip`です。

登録手順:

1. Claudeの「Customize > Skills」を開きます。
2. スキル追加画面から`slide-system-skill-v0.1.1.zip`をアップロードします。
...
- バージョン: `0.7.1`
- 状態: 初回スキル検証の問題を修正・`v0.1.1`で再検証待ち
