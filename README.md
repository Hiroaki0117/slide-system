...
1. `40_VISUALS.md`、`60_QA.md`を作成する。
...
3. `00_MASTER.md`、`10_CONTENT.md`、`20_DESIGN.md`、`30_LAYOUTS.md`、`50_OUTPUTS.md`および完成済みの個別仕様書をプロジェクト知識に追加します。
