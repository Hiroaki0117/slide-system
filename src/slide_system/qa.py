...
def create_qa_report(
    ...
    *,
    ...
    issues = _static_issues(static, 1)
    ...
    passed_gates = int(static.get("status") == "PASS") + int(visual.get("status") == "PASS") + theme_passed
    report = {
        "schema_version": "1.0",
        "run_id": run_id,
        "attempt": attempt,
        ...
        "legacy_reports": {"static": "static-qa-legacy.json", "visual": "visual-qa-legacy.json"},
        "checked_at": now_iso(),
    }
